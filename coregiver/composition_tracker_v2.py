...
def track_composition(collision_report_file, composition_input_file, ejection_file):
    ...
    for i in range(len(collisions)): 
        ...
        target_core_mass = target_core_frac * target_mass
        proj_core_mass = proj_core_frac * proj_mass
        total_core_mass = target_core_mass + proj_core_mass
    ...
    ############### DISRUPTIVE COLLISIONS ############### 
            ...
            if collision_type == 2:
                ...
                M_core_lr = target_core_mass + min(proj_core_mass, largest_remnant_mass - target_mass)
                CMF_lr = M_core_lr/largest_remnant_mass
                CMF_frag = (total_core_mass - M_core_lr)/(target_mass + proj_mass - largest_remnant_mass)
            ...
            # Collision type 3 and 4 -> erosive collisions
                ...
                M_core_lr = min(largest_remnant_mass, target_core_mass)
                CMF_lr = M_core_lr/largest_remnant_mass
                CMF_frag = (total_core_mass - M_core_lr)/(target_mass + proj_mass - largest_remnant_mass)
            ...
            if frag_core_frac < 0.0:
                ...
                print ('ERROR: Fragment CMF is greater than 1.0 at time and is : ', time, frag_core_frac, total_core_mass, M_core_lr, target_mass, proj_mass, largest_remnant_mass)
                sys.exit(1)
